...
export default function ContactoPage() {
  // Extract colors from palette - same approach as in Home
            ...
            <div className="p-8 bg-white">
              ...
              <dl className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <dd className="text-sm font-semibold" style={{ color: colores.texto }}>Cerrado</dd>
                </div>
              </dl>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg mb-4" style={{ color: colores.texto }}>
                En Solo Para Eva estamos comprometidos con ofrecer la mejor experiencia para nuestros clientes. 
              </p>
              <p className="text-lg mb-4" style={{ color: colores.texto }}>
